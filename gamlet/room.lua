...
gamooga.onconnect(function(conn_id)
    ...
    gamooga.send(conn_id, "userlist", {ol=conn_id_photo_map})
...
gamooga.onmessage("profilephoto", function(conn_id, s)
    conn_id_photo_map[conn_id] = s
    gamooga.broadcast("photorecv", s)
end)
